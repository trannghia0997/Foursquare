...
class _$UserDetailsImpl with DiagnosticableTreeMixin implements _UserDetails {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserDetails(id: $id, phone: $phone, createdBy: $createdBy, createdDate: $createdDate, lastModifiedBy: $lastModifiedBy, lastModifiedDate: $lastModifiedDate, user: $user)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, phone, createdBy,
      createdDate, lastModifiedBy, lastModifiedDate, user);
...
abstract class _UserDetails implements UserDetails {
  const factory _UserDetails(
      ...
      final String? lastModifiedBy,
      final DateTime? lastModifiedDate,
      final User? user}) = _$UserDetailsImpl;
